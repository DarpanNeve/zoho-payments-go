...
// VerifyWebhook verifies the webhook signature; rejects replays older than 5 minutes.
...
// VerifyWebhookWithTolerance is VerifyWebhook with a configurable replay window.
